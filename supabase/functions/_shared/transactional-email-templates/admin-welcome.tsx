...
const AdminWelcomeEmail = ({ name, email, password, loginUrl }: AdminWelcomeProps) => (
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>Hi {name || 'Admin'},</Text>

        <Text style={text}>
          An admin account has been created for you on the {SITE_NAME} platform.
          Use the credentials below to sign in to the Admin Portal.
        </Text>
        ...
        <Text style={text}>
          ...
          using the "Forgot your password?" link on the sign-in page.
        </Text>

        <Section style={{ textAlign: 'center' as const, margin: '30px 0' }}>
          <Button style={button} href={loginUrl || 'https://datadelve.io/admin/login'}>
        ...
        <Text style={footer}>
          If you weren't expecting this email, please ignore it or contact us immediately.
        </Text>
        <Text style={footer}>
...
export const template = {
  ...
  subject: 'Your Delvetek Admin Portal Login Credentials',
  displayName: 'Admin welcome',
  previewData: { name: 'David', email: 'admin@example.com', password: 'TempPass_!1', loginUrl: 'https://datadelve.io/admin/login' },
