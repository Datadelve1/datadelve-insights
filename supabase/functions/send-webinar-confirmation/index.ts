        ...
        html: `
          <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #FAF8F5; padding: 40px 30px; border-radius: 16px;">
            <div style="text-align: center; margin-bottom: 30px;">
              <img src="https://delve-insight-connect.lovable.app/delveschool-full-logo.png" alt="DelveSchool" style="width: 120px; height: auto; margin-bottom: 12px;" />
            ...
            <div style="text-align: center; padding: 20px 0;">
              ...
              <a href="https://meet.google.com/imz-pqyp-kib" style="display: inline-block; background: #D4A017; color: #FFFFFF; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: 600;">Join Webinar</a>
